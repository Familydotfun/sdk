...
__export(src_exports, {
  HOUSE_PERMISSIONS: () => HOUSE_PERMISSIONS,
  MODULE_SURFACE_LABELS: () => MODULE_SURFACE_LABELS,
  SDK_VERSION: () => SDK_VERSION,
  assertPermission: () => assertPermission,
  createFamilySDK: () => createFamilySDK,
  describePermissionList: () => describePermissionList,
  hasPermission: () => hasPermission,
  isFamilyContext: () => isFamilyContext,
